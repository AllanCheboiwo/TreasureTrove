                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-4 col-md-2 d-grid justify-content-center align-items-center align-content-center" style="padding: 10px;">
                                            <div class="input-group d-flex" style="width: 100%;">
                                                <button class="btn btn-primary btn-sm d-xxl-flex justify-content-xxl-center align-items-xxl-center" type="button" onclick="cartAjax({\'pname\': \''.$prod['productName'].'\', \'pid\': '.$prod['productId'].', \'price\': \''.$prod['price'].'\', \'quantity\': '.($prod['quantity'] - 1).'}, \'update\')" style="background: #1cc4ab;border-style: none;box-shadow: 0px 0px 3px #169884;">
